...
String password;
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(64, 107, 125));
        ...
        jPasswordField1.setBackground(new java.awt.Color(64, 107, 125));
        jPasswordField1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPasswordField1.setForeground(new java.awt.Color(244, 244, 244));
        ...
        jLabel5.setForeground(new java.awt.Color(34, 69, 63));
        ...
        jButton1.setText("Log in as a faculty");
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        String query="SELECT * FROM mydb.`student table` WHERE `userid`=? AND `password`=MD5(?)";
        ...
        try{
            ...
            if(rs.next()){
                //result ashle
        StudentHomePage log=new StudentHomePage();
        log.StudentID=userid;
        log.setVisible(true);
        log.pack();
        log.setLocationRelativeTo(null);
        this.dispose();
                //SESSION VARIABLES BAKI
                JOptionPane.showMessageDialog(null,"YES Student logged in");

            }else{
                JOptionPane.showMessageDialog(null,"Incorrect username or password");
            }
        }catch(SQLException ex){
            Logger.getLogger(LoginForm.class.getName()).log(Level.SEVERE,null,ex); ////it was register.class before 
        }
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        ///create an object of the frame that u want the variable to be in to
        ResetPasswordStudent rgf = new ResetPasswordStudent();
        rgf.setVisible(true);
        rgf.pack();
